...
async def get_service(
    ...
    service_service = container.service_service()
    return from_domain_service(await service_service.get_service(id))
...
async def update_service(
    ...
    service = await service_service.update_service(service_model, id)
...
async def publish_service(
    ...
    service = await service_service.publish_service(id=id, published=published)

    return from_domain_service(service=service)
