...
class AssistantAssembler:
    ...
    def _get_allowed_attachments(self, assistant: Assistant):
    ...
    def from_assistant_to_model(self, assistant: Assistant):
        ...
        allowed_attachments = self._get_allowed_attachments(assistant)
        tools = Tools(
            assistants=[
    ...
    def from_assistant_to_default_assistant_model(
        ...
        assistant_public = self.from_assistant_to_model(assistant=assistant)
